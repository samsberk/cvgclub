				...
				<div class="row">
					...
					<div class="col-md-8">
                        ...
                        <div style="width:100%;min-height:200px;background:ghostwhite!important;border-radius:10px; padding:2% 4% 2% 4%;">
                            ...
                            <p style="font-weight:bold;">
                                <span class="glyphicon glyphicon-chevron-right"></span> Go to <a href="Events" target="_blank">Event Page</a><br />
                        ...
                        <div style="width:100%;min-height:200px;background:ghostwhite!important;border-radius:10px; padding:2% 4% 2% 4%;">
                            ...
                            <p style="font-size:18px;">
                                <asp:Label ID="boowlbl" runat="server"></asp:Label>
                                ...
                                <asp:Label ID="grftlbl" runat="server"></asp:Label>
                                <asp:Label ID="qlbl" runat="server"></asp:Label>
                                <asp:Label ID="sktchlbl" runat="server"></asp:Label>
                                <asp:Label ID="pntlbl" runat="server"></asp:Label>
                                ...
                                <asp:Label ID="lgplbl" runat="server"></asp:Label>
                                <asp:Label ID="wdlbl" runat="server"></asp:Label>
                                <asp:Label ID="oslbl" runat="server"></asp:Label>
                                <asp:Label ID="fplbl" runat="server"></asp:Label>
                                <asp:Label ID="dnclbl" runat="server"></asp:Label>
                                <asp:Label ID="snglbl" runat="server"></asp:Label>
                                <asp:Label ID="plbl" runat="server"></asp:Label>
                                <asp:Label ID="pglbl" runat="server"></asp:Label>
                                <asp:Label ID="rnglylbl" runat="server"></asp:Label>
                                <asp:Label ID="drmtcslbl" runat="server"></asp:Label>
                            </p>
                        </div><br />
                        ...
                        <div class="form-group">
                            <asp:DropDownList ID="deregevdrpdwn" CssClass="form-control" runat="server">
                                ...
                                <asp:ListItem>Best Out of Waste</asp:ListItem>
                                <asp:ListItem>Documentary Video</asp:ListItem>
                                <asp:ListItem>PPT Presentation</asp:ListItem>
                                <asp:ListItem>Treasure Hunt</asp:ListItem>
                                <asp:ListItem>Writing Skills (ALL)</asp:ListItem>
                                <asp:ListItem>Graffiti</asp:ListItem>
                                <asp:ListItem>Quiz</asp:ListItem>
								<asp:ListItem>Sketching</asp:ListItem>
                                <asp:ListItem>Painting</asp:ListItem>
                                <asp:ListItem>Code Hunt</asp:ListItem>
                                <asp:ListItem>Model Making</asp:ListItem>
                                <asp:ListItem>LAN Gaming (NFS)</asp:ListItem>
								<asp:ListItem>Web Designing</asp:ListItem>
                                <asp:ListItem>Oratory Skills (ALL)</asp:ListItem>
                                <asp:ListItem>Face Painting</asp:ListItem>
                                <asp:ListItem>Dancing</asp:ListItem>
                                <asp:ListItem>Singing</asp:ListItem>
								<asp:ListItem>Poetry (ALL)</asp:ListItem>
                                <asp:ListItem>Photography</asp:ListItem>
                                <asp:ListItem>Rangoli</asp:ListItem>
                                <asp:ListItem>Dramatics</asp:ListItem>
                            </asp:DropDownList>
