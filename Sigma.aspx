<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sigma.aspx.cs" Inherits="Sigma" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CVGClub | Club Sigma | SCRIET CVG Club</title>
    ...
    <form id="form1" runat="server">
		...
		<div id="p-nasa">
			<div class="title-cvg">
				...
				<a href="Sigma" class="link-cvgclub click-on" style="font-family:'Finger Paint';">Sigma</a><br />
			</div>
			<div class="box-2" style="z-index:9;">
				<div class="row">
					<div class="col-md-2"></div>
					<div class="col-md-8">
						<h4 style="font-weight:bold;text-align:center;font-family:'Finger Paint';margin-top:10vh;">Club Sigma</h4>
						...
						<div class="panel-body">
							...
							<div class="panel panel-info" style="background-color:transparent;border-radius:0px;">
								<div class="panel-heading" style="background:black;border-radius:0px;font-family:'Finger Paint';">
									<b class="panel-title">Sigma Events Members</b>
								</div>
