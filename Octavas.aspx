<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Octavas.aspx.cs" Inherits="Octavas" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CVGClub | Club Octavas | SCRIET CVG Club</title>
    ...
    <form id="form1" runat="server">
		...
		<div id="p-nasa">
			<div class="title-cvg">
				...
				<a href="Octavas" class="link-cvgclub click-on" style="font-family:'Finger Paint';">Octavas</a><br />
			</div>
			<div class="box-2" style="z-index:9;">
				<div class="panel-body" style="padding:5px;">
					<div class="row">
						...
						<div class="col-md-8">
							<h4 style="font-weight:bold;text-align:center;font-family:'Finger Paint';margin-top:10vh;">Club Octavas</h4>
							...
							<div class="panel-body">
								...
								<div class="panel panel-info" style="background-color:transparent;border-radius:0px;">
									<div class="panel-heading" style="background:black;border-radius:0px;font-family:'Finger Paint';">
										<b class="panel-title">Octavas Events Members</b>
									</div>
									<div class="panel-body text-right">
										...
										<div class="panel-group" id="octev">
											<div class="panel panel-default" style="background-color:transparent;border:none;">
												<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp1" class="link"><b>Singing&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
											...
											<div class="panel panel-default" style="background-color:transparent;border:none;">
												<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp2" class="link"><b>Dancing&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
											...
											<div class="panel panel-default" style="background-color:transparent;border:none;">
												<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp3" class="link"><b>Instrumental&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
											...
											<div class="panel panel-default" style="background-color:transparent;border:none;">
												<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp4" class="link"><b>Dramatics&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
