<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enquizitia.aspx.cs" Inherits="Enquizitia" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CVGClub | Club Enquizitia | SCRIET CVG Club</title>
    ...
    <form id="form1" runat="server">
		...
		<div id="p-nasa">
			<div class="title-cvg">
				...
				<a href="Enquizitia" class="link-cvgclub click-on" style="font-family:'Finger Paint';">Enquizitia</a><br />
			</div>
			<div class="box-2" style="z-index:9;">
				<div class="row">
					<div class="col-md-2"></div>
					<div class="col-md-8">
						<h4 style="font-weight:bold;text-align:center;font-family:'Finger Paint';margin-top:10vh;">Club Enquizitia</h4>
						...
						<div class="panel-body">
							...
							<div class="panel panel-info" style="background-color:transparent;border-radius:0px;">
								<div class="panel-heading" style="background:black;border-radius:0px;font-family:'Finger Paint';">
									<b class="panel-title">Enquizitia Events Members</b>
								</div>
								<div class="panel-body text-right">
									...
									<div class="panel-group" id="octev">
										<div class="panel panel-default" style="background-color:transparent;border:none;">
											<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp1" class="link"><b>Code Hunt&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
										...
										<div class="panel panel-default" style="background-color:transparent;border:none;">
											<div class="panel-heading" style="background:black;border:none;text-align:center;color:skyblue;"><b class="panel-title"><a data-toggle="collapse" data-parent="#octev" href="#colp2" class="link"><b>Gaming&emsp;<span class="glyphicon glyphicon-chevron-down"></span></b></a></b></div>
