        ...
        <div id="nolist" class="container-fluid" style="height:500px;background:ghostwhite;overflow-y:scroll;padding:10px;border-radius:5px;border:1px solid gray;">            
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="EmailID" DataSourceID="SqlDataSource1" ShowHeaderWhenEmpty="True" Width="100%">
                <Columns>
                    ...
                    <asp:BoundField DataField="HRContact" HeaderText="HRContact" SortExpression="HRContact" />
                    <asp:BoundField DataField="EventAttend" HeaderText="EventAttend" SortExpression="EventAttend" />
                    <asp:BoundField DataField="CRParticipation" HeaderText="CRParticipation" SortExpression="CRParticipation" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:escrietConnectionString %>" SelectCommand="SELECT [EmailID], [Name], [Branch], [Batch], [Designation], [CompanyName], [Contact], [HRContact], [EventAttend], [CRParticipation], [Contribution], [Verification], [RegDate] FROM [Alumni]"></asp:SqlDataSource>
        </div><br />
