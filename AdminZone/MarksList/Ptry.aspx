<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ptry.aspx.cs" Inherits="AdminZone_MarksList_Ptry" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h5 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Poetry</h5>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Department - Branch - Year</th><th>Self Written</th><th>Famous Poet's</th><th>College</th><th>Contact</th></tr>
