<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lgp.aspx.cs" Inherits="AdminZone_MarksList_Lgp" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h5 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for LAN Gaming (PUBG)</h5>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Department - Branch - Year</th><th>Team</th><th>College</th><th>Contact</th></tr>
