...
public partial class AdminZone_Alumni_Management : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dta = dm.SelectQuery(cmd);
        if (dta.Rows.Count > 0)
        {
            cmd = "select * from Alumni";
            DataTable dast = dm.SelectQuery(cmd);
            ...
            DataTable dvst = dm.SelectQuery(cmd);
            ...
            st = "Not Verified";
            cmd = "select * from Alumni where Verification='" + st + "'";
            DataTable dnvst = dm.SelectQuery(cmd);
            ...
            DataTable drej = dm.SelectQuery(cmd);
    ...
    protected void btndelrej_Click(object sender, EventArgs e)
    {
        ...
        DataTable delrej = dm.SelectQuery(cmd);
