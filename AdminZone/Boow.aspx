<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Boow.aspx.cs" Inherits="AdminZone_Boow" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Best Out of Waste List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h5 style="margin-top:20px;font-weight:bold;text-align:center;">Attendance List for Best Out of Waste</h5>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Department - Branch - Year</th><th>College</th><th>Contact</th><th>Attendance</th></tr>
